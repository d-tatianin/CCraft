...
namespace CCraft
{
	...
	*/
	...
	Menu::Menu(Button &button1, Button &button2, Button &button3)
		...
		button1_buffer(button1.data, (30*sizeof(float))), button2_buffer(button2.data, (30 * sizeof(float))), 
		button3_buffer(button3.data, (30 * sizeof(float))), menuMat(1.0f)
	{
